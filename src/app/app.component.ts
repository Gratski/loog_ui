...
export class AppComponent {
  ...
  public submitCode() {
    ...
    this.http.post<CodeAnalisys>('/api/code/analysis2', {
      model: "gpt-3.5-turbo",
      messages: [
        {role: "user", content: "I am a software engineer. I want to change the following code for better performance while using the minimum amount of CPU and memory."},
